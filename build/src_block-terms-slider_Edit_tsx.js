"use strict";
(self["webpackChunkncmaz_core"] = self["webpackChunkncmaz_core"] || []).push([["src_block-terms-slider_Edit_tsx"],{

/***/ "./src/block-terms-slider/Edit.tsx":
/*!*****************************************!*\
  !*** ./src/block-terms-slider/Edit.tsx ***!
  \*****************************************/
...
/* harmony import */ var _apollo_client__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @apollo/client */ "./node_modules/graphql-tag/lib/index.js");
/* harmony import */ var _apollo_client__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @apollo/client */ "./node_modules/@apollo/client/react/hooks/useQuery.js");
/* harmony import */ var _frontend_components_SectionSliderNewCategories_SectionSliderNewCategories__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../frontend-components/SectionSliderNewCategories/SectionSliderNewCategories */ "./src/frontend-components/SectionSliderNewCategories/SectionSliderNewCategories.tsx");
...
/* harmony import */ var _contains_contants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../contains/contants */ "./src/contains/contants.ts");
/* harmony import */ var _components_SliderSettings__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/SliderSettings */ "./src/components/SliderSettings.tsx");
...
function Edit(props) {
  ...
  if (typeOfTerm === "category") {
    if (filterDataBy === "by_filter") {
      ...
      GQL_QUERY__string = _contains_contants__WEBPACK_IMPORTED_MODULE_11__.GQL_QUERY_GET_CATEGORIES_BY_FILTER;
      GQL_QUERY__string_xxx = "GQL_QUERY_GET_CATEGORIES_BY_FILTER";
    } else {
      variables = {
        termTaxonomId: (categories || []).map(item => item.value)
      };
      GQL_QUERY__string = _contains_contants__WEBPACK_IMPORTED_MODULE_11__.GQL_QUERY_GET_CATEGORIES_BY_SPECIFIC;
  ...
  if (typeOfTerm === "tag") {
    if (filterDataBy === "by_filter") {
      ...
      GQL_QUERY__string = _contains_contants__WEBPACK_IMPORTED_MODULE_11__.GQL_QUERY_GET_TAGS_BY_FILTER;
      GQL_QUERY__string_xxx = "GQL_QUERY_GET_TAGS_BY_FILTER";
    } else {
      variables = {
        termTaxonomId: (tags || []).map(item => item.value)
      };
      GQL_QUERY__string = _contains_contants__WEBPACK_IMPORTED_MODULE_11__.GQL_QUERY_GET_TAGS_BY_SPECIFIC;
  ...
  const {
    ...
    error,
    data
  } = (0,_apollo_client__WEBPACK_IMPORTED_MODULE_14__.useQuery)(gqlQuery, {
    variables
  });
  ...
  const renderGeneralSetting = () => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "w-full space-y-1"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_SliderSettings__WEBPACK_IMPORTED_MODULE_12__["default"], {
  ...
  const renderPreviewContent = () => {
    ...
    }, hasBackground && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_frontend_components_BackgroundSection_BackgroundSection__WEBPACK_IMPORTED_MODULE_9__["default"], null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_frontend_components_SectionSliderNewCategories_SectionSliderNewCategories__WEBPACK_IMPORTED_MODULE_8__["default"], {
      heading: heading,
...
/***/ "./src/frontend-components/SectionSliderNewCategories/SectionSliderNewCategories.tsx":
/*!*******************************************************************************************!*\
  !*** ./src/frontend-components/SectionSliderNewCategories/SectionSliderNewCategories.tsx ***!
  \*******************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _hooks_useSliderGlidejs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../hooks/useSliderGlidejs */ "./src/hooks/useSliderGlidejs.ts");
...
const SectionSliderNewCategories = _ref => {
  let {
    heading,
    subHeading,
    className = "",
  ...
  (0,_hooks_useSliderGlidejs__WEBPACK_IMPORTED_MODULE_7__["default"])({
    sliderRef,
    itemPerView,
    sliderStartAt,
    sliderAutoplayTime,
  ...
  const renderCard = (item, index) => {
    ...
    switch (categoryCardType) {
      case "card2":
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_CardCategory2_CardCategory2__WEBPACK_IMPORTED_MODULE_3__["default"], {
          taxonomyNode: item.node,
          index: topIndex
        });

      case "card3":
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_CardCategory3_CardCategory3__WEBPACK_IMPORTED_MODULE_4__["default"], {
          taxonomyNode: item.node
        });

      case "card4":
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_CardCategory4_CardCategory4__WEBPACK_IMPORTED_MODULE_5__["default"], {
          taxonomyNode: item.node,
          index: topIndex
        });

      case "card5":
        return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_CardCategory5_CardCategory5__WEBPACK_IMPORTED_MODULE_6__["default"], {
          taxonomyNode: item.node
        });
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "glide__slides !p-0 !m-0"
  }, categories.map((item, index) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    key: index,
    className: `!list-none glide__slide ${itemClassName}`
  }, renderCard(item, index)))))));
};

/* harmony default export */ __webpack_exports__["default"] = (SectionSliderNewCategories);
...
//# sourceMappingURL=src_block-terms-slider_Edit_tsx.js.map