...
/* harmony import */ var _apollo_client__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @apollo/client */ "./node_modules/graphql-tag/lib/index.js");
/* harmony import */ var _apollo_client__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @apollo/client */ "./node_modules/@apollo/client/react/hooks/useQuery.js");
...
/* harmony import */ var _contains_contants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../contains/contants */ "./src/contains/contants.ts");
...
function Edit(props) {
  ...
  if (filterDataBy === "by_specific") {
    ...
    GQL_QUERY__string = _contains_contants__WEBPACK_IMPORTED_MODULE_8__.GQL_QUERY_GET_USERS_BY_SPECIFIC;
    GQL_QUERY__string_xxx = "GQL_QUERY_GET_USERS_BY_SPECIFIC";
  } else {
    GQL_QUERY__string = _contains_contants__WEBPACK_IMPORTED_MODULE_8__.GQL_QUERY_GET_USERS_BY_FILTER;
  ...
  const gqlQuery = _apollo_client__WEBPACK_IMPORTED_MODULE_9__.gql`
		${GQL_QUERY__string}
	`;
  const {
    loading,
    error,
    data
  } = (0,_apollo_client__WEBPACK_IMPORTED_MODULE_10__.useQuery)(gqlQuery, {
    variables
  });
  ...
  const renderFilterPostsContent = () => {
    ...
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("legend", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Choose user role-in", "ncmaz-core")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_select__WEBPACK_IMPORTED_MODULE_11__["default"], {
