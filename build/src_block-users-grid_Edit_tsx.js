...
/* harmony import */ var _apollo_client__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @apollo/client */ "./node_modules/graphql-tag/lib/index.js");
/* harmony import */ var _apollo_client__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @apollo/client */ "./node_modules/@apollo/client/react/hooks/useQuery.js");
...
function Edit(props) {
  ...
  const gqlQuery = _apollo_client__WEBPACK_IMPORTED_MODULE_11__.gql`
		${GQL_QUERY__string}
	`;
  const {
    loading,
    error,
    data
  } = (0,_apollo_client__WEBPACK_IMPORTED_MODULE_12__.useQuery)(gqlQuery, {
    variables
  });
  ...
  const renderGeneralSetting = () => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)(`If you enter this field will overwrite the field 'Choose items per row' above`, "ncmaz-core")
