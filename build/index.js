...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_ncmaz_core"] = window["webpackJsonp_ncmaz_core"] || [];
...
/***/ "./src/components/InputNumberPerPage.js":
/*!**********************************************!*\
  !*** ./src/components/InputNumberPerPage.js ***!
  \**********************************************/
/*! exports provided: default */
...
const InputNumberPerPage = ({
  onChange,
  defaultValue = 6
}) => {
  const [perPage, setPerPage] = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["useState"])(defaultValue);
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    onChange && onChange(perPage);
  }, [perPage]);
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "w-full space-y-1"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("legend", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])("Number per page", "ncmaz-core")), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["__experimentalNumberControl"], {
...
/***/ "./src/components/InputSearchAuthors.js":
/*!**********************************************!*\
  !*** ./src/components/InputSearchAuthors.js ***!
  \**********************************************/
/*! exports provided: default */
...
const InputSearchAuthors = ({
  onChange,
  defaultValue = []
}) => {
  //  * loading | err | done
  const [isState, setIsState] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])("");
  const [selected, setSelected] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(defaultValue);
  const [authors, setAuthors] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])([]);
...
/***/ "./src/components/InputSearchCategories.js":
/*!*************************************************!*\
  !*** ./src/components/InputSearchCategories.js ***!
  \*************************************************/
/*! exports provided: default */
...
const InputSearchCategories = ({
  onChange,
  defaultValue = []
}) => {
  //  * loading | err | done
  const [isState, setIsState] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])("");
  const [selected, setSelected] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(defaultValue); // Why need/ Readmore from InputSearchPost component

  const [objData, setObjData] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])({});
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    onChange && onChange(selected);
  }, [selected]);
  ...
  const handleInputChange = lodash__WEBPACK_IMPORTED_MODULE_3___default.a.debounce(function (e) {
    !!e && getCategoriesAxios(e);
  }, 200);

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "w-full space-y-1"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("legend", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])("Type and select categories", "ncmaz-core")), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_select__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
/***/ "./src/components/InputSearchPosts.js":
/*!********************************************!*\
  !*** ./src/components/InputSearchPosts.js ***!
  \********************************************/
/*! exports provided: default */
...
const InputSearchPosts = ({
  onChange,
  defaultValue = []
}) => {
  //  * loading | err | done
  const [isState, setIsState] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])("");
  const [selected, setSelected] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(defaultValue); // Why need objData? chung ta se sd Object.value(objData) lam data cho select
  ...
  const converteArrToObj = data => {
    ...
    return data.reduce((obj, item) => {
      ...
      return { ...obj,
        [item.slug]: {
          value: item.slug,
          label: (_item$title = item.title) === null || _item$title === void 0 ? void 0 : _item$title.rendered
        }
      };
    }, {});
  };
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "w-full space-y-1"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("legend", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])("Type and select posts", "ncmaz-core")), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_select__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
/***/ "./src/components/InputSearchTags.js":
/*!*******************************************!*\
  !*** ./src/components/InputSearchTags.js ***!
  \*******************************************/
/*! exports provided: default */
...
const InputSearchTags = ({
  onChange,
  defaultValue = []
}) => {
  //  * loading | err | done
  const [isState, setIsState] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])("");
  const [selected, setSelected] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(defaultValue); // Why need? read more IInputSearchPost Component
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "w-full space-y-1"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("legend", null, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])("Type and select tags", "ncmaz-core")), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_select__WEBPACK_IMPORTED_MODULE_6__["default"], {
...
const SelectOrder = ({
  ...
  const [order, setOrder] = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["useState"])(defaultValue);
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    onChange && onChange(order);
  }, [order]);
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["SelectControl"], {
    label: "Order",
    value: order,
    options: [{
      label: "desc",
...
/***/ "./src/components/SelectOrderBy.js":
/*!*****************************************!*\
  !*** ./src/components/SelectOrderBy.js ***!
  \*****************************************/
/*! exports provided: default */
...
const SelectOrderBy = ({
  ...
  const [orderBy, setOrderBy] = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["useState"])(defaultValue);
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
...
/***/ "./src/components/SelectPostFormat.js":
/*!********************************************!*\
  !*** ./src/components/SelectPostFormat.js ***!
  \********************************************/
/*! exports provided: default */
...
const SelectPostFormat = ({
  ...
  const [format, setFormat] = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["useState"])(defaultValue);
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
...
/* harmony default export */ __webpack_exports__["default"] = (SelectPostFormat);
...
function Edit(props) {
  ...
  const renderFilterPostsContent = () => {
    if (option === "by_post_specific") {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_InputSearchPosts__WEBPACK_IMPORTED_MODULE_3__["default"], {
        defaultValue: posts,
    ...
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_InputSearchTags__WEBPACK_IMPORTED_MODULE_5__["default"], {
      defaultValue: tags,
      onChange: tags => setAttributes({
        tags
      })
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_InputSearchAuthors__WEBPACK_IMPORTED_MODULE_11__["default"], {
      defaultValue: authors,
      onChange: authors => setAttributes({
        authors
      })
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_SelectOrderBy__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_InputNumberPerPage__WEBPACK_IMPORTED_MODULE_10__["default"], {
      defaultValue: postNumber,
      onChange: postNumber => setAttributes({
        postNumber
      })
    }));
  }; //
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__["useBlockProps"])(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__["InspectorControls"], {
    key: "setting"
...
function save(props) {
  ...
  if (option === "by_post_specific" && !!posts && !!posts.length) {
    params = {
      slug: posts.map(item => item.value)
    };
  }
