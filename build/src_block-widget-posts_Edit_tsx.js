...
/* harmony import */ var _hooks_usePostGqlQuery__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../hooks/usePostGqlQuery */ "./src/hooks/usePostGqlQuery.ts");
/* harmony import */ var _contains_common__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../contains/common */ "./src/contains/common.ts");
...
function Edit(props) {
  ...
  const {
    ...
    loading,
    data
  } = (0,_hooks_usePostGqlQuery__WEBPACK_IMPORTED_MODULE_13__["default"])(attributes); // ---- SAVE graphQLvariables ----
  ...
  const renderSidebarSetting = () => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_7__.InspectorControls, {
      ...
      options: _contains_common__WEBPACK_IMPORTED_MODULE_14__.OPTIONS_FILTER_DATA_BY,
